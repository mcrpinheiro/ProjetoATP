...
1. **Carregar um ficheiro JSON**:
    - Carregar um ficheiro JSON para a memória.

2. **Verificar as Publicações Disponíveis**.
    - Ver uma tabela com as publicações disponíveis em memória.
